...
public class CourseManagerFrame extends JFrame {
    ...
    private JTextField deadlineField = new JTextField(18); // YYYY-MM-DD
    ...
    public CourseManagerFrame() {
        ...
        c.gridx=0; c.gridy=y; form.add(new JLabel("Available Seats"),c);
        c.gridx=1; form.add(availableSeatsField,c); y++;

        c.gridx=0; c.gridy=y; form.add(new JLabel("Drop Deadline (YYYY-MM-DD)"),c);
        c.gridx=1; form.add(deadlineField,c); y++;
